...
// DATE: 10/29/23
// This is the Quest List interface
...
*/
    ...
    Quest(const std::string& title, const std::string& description, bool quest_completion, int experience_points, const std::vector<Quest*>& dependencies, const std::vector<Quest*>& subquests) :
        title_{title}, description_{description}, completed_{quest_completion}, experience_points_{experience_points}, dependencies_{dependencies}, subquests_{subquests} {
    }
};
...
*/
        bool addQuest(const std::string& title, const std::string& quest_description, const bool& quest_completion, const int& experience_points, const std::vector<Quest*>& dependencies, const std::vector<Quest*>& subquests);
...
*/
        bool questAvailable(Quest* quest_available);
    ...
    [Quest Description]\n\n
*/
        void printQuest(Quest* print_quest);
...
*/
        ...
        void questQuery_helper(Quest* quest_title);
        void quest_detail_helper(Quest* main_quest, int spaces);
