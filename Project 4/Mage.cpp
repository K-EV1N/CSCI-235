    ...
    if (getRace() == "UNDEAD") {
        setVitality(getVitality() + 3); // They get 3 additional vitality if the race is UNDEAD
            ...
            if (getCastingWeapon() == "WAND") {
                setVitality(getVitality() + 2); // If their casting weapon is WAND, they get additional 2 vitality
            } else if (getCastingWeapon() == "STAFF") {
                setVitality(getVitality() + 3); // If their casting weapon is STAFF, they get additional 3 vitality
            } if (hasIncarnateSummon() == true) {
                setVitality(getVitality() + 1); // If they can summon incarnate, they get an additional 1 vitality
            }
    }
}
