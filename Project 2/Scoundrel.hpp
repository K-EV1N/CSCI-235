...
*/
    ...
    @post       : The private members are set to the values of the corresponding 
                 ...
                 If the Faction is not provided or invalid, the variable should be 
                  set to "NONE". 
*/
        Scoundrel(const std::string& name, const std::string& race, int vitality = 0, int armor = 0, int level = 0, bool enemy = false, std::string dagger = "WOOD", std::string faction = "NONE", bool disguise = false); // Paramterized Constructor
